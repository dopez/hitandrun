...
$.extend($.validator, {
	...
	messages: {
		...
		digits: "숫자만 입력 가능합니다",
		creditcard: "신용카드번호형식에 일치하지 않습니다",
		equalTo: "입력사항이 일치하지 않습니다",
		accept: "값이 형식에 일치하지 않습니다.",
		maxlength: $.format("{0}자이상 입력할수 없습니다."),
		minlength: $.format("최소{0}자이상."),
		rangelength: $.format("{0}과 {1}사이의 단어를 입력하세요."),
		range: $.format("{0}과 {1}사이의 값을 입력하세요."),
		max: $.format("{0}과 같거나 작은값을 입력하세요."),
		min: $.format("{0}과 같거나 큰값을 입력하세요.")
	},
