...
<script type="text/javascript" src="<c:url value='/egovframework/rte/cmmn/validator.do'/>"></script>
...
function fn_egov_selectList() {
   	document.detailForm.action = "<c:url value='/sample/egovSampleList2.do'/>";
   	document.detailForm.submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.detailForm.action = "<c:url value='/sample/deleteSample2.do'/>";
   	document.detailForm.submit();		
}
...
function fn_egov_save() {	
	...
	if(!validateSampleVO(frm)){
    	...
    	frm.action = "<c:url value="${registerFlag == '등록' ? '/sample/addSample2.do' : '/sample/updateSample2.do'}"/>";
        frm.submit();
    }
}
...
<div id="content_pop">
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#D3E2EC" bordercolordark="#FFFFFF" style="BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;">
		...
		<tr>
			...
			<td class="tbtd_content">
				<form:input path="name" maxlength="30" cssClass="text"/>
		...
		<tr>
			...
			<td class="tbtd_content">
				<form:input path="regUser" maxlength="10" cssClass="text"  />
