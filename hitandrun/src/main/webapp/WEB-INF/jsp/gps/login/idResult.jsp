...
function fnBack(){
	document.gpsLoginVO.action = "<c:url value='/gps/login/idSearch.do'/>";
	document.gpsLoginVO.submit();
}

function fn_passwordReissue(){
	document.gpsLoginVO.action = "<c:url value='/gps/login/passwordReissue.do'/>";
	document.gpsLoginVO.submit();
}
</script>
</head>
...
<div class="popupContents">
	<div class="popupHeader">
		<h3></h3>
		<p class="close_btn"><img src="/images/gps/cmm/icon/x.gif" alt="닫기" title="닫기" style="cursor:hand;" onclick="window.close();return false;" onkeypress="this.onclick();return false;"/></p>
	</div>
	
	<h3><img src="/images/gps/title/008.gif" alt="아이디찾기 결과" title="아이디찾기 결과"/></h3>
	<form:form commandName="gpsLoginVO" action="/gps/login/selectIdSearch.do" name="idSearchForm" method="post">
	<div class="popupCn">
		<div class="popupInnerCn">
			<div class="popupIdSearch">
				<table class="idSearchResult" summary="아이디찾기 결과">
				<caption>아이디찾기 결과</caption>
				<tr>
					<td class="text">성명</td>
					<td><input type="text" name="nm" maxlength="20" title="성명"/></td>
				</tr>
				<tr>
		...
		<div class="popupFooter">
			...
			<tr>
				<td align="center">
					...
					<tr>
						<td><img src="/images/gps/contents/login/bt_id_on.gif" alt="아이디찾기" title="아이디찾기" style="cursor:hand;" onclick="fn_idsearch();return false;" onkeypress="this.onclick();return false;"/></td>
						<td><img src="/images/gps/contents/login/bt_pw_on.gif" alt="비밀번호재발급" title="비밀번호재발급" style="cursor:hand;" onclick="fn_passwordReissue();return false;" onkeypress="this.onclick();return false;"/></td>
						<td><img src="/images/gps/contents/member/bt_cancel_off.gif" alt="취소" title="취소" style="cursor:hand;" onclick="window.close();return false;" onkeypress="this.onclick();return false;"/></td>
					</tr>
					</table>
				</td>
			</tr>
