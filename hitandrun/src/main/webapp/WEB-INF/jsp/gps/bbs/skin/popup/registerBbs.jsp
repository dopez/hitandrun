			...
			<td>
				...
				<tr>
					<td>
						...
						<tr>
							<th>이메일</th>
							<td><form:input path="email" maxlength="50" cssClass="wi300 validate[optional,length[1,100],custom[email]" cssStyle="ime-mode:inactive"/></td>
						</tr>
						<tr>
							<th>홈페이지</th>
							<td><form:input path="hmpg" maxlength="50" cssClass="wi300 validate[optional,length[1,100]]" cssStyle="ime-mode:inactive"/></td>
						</tr>
						<tr>
							<th>내용</th>
						...
						<tr>
							<th>비밀번호</th>
							<td>
								<form:password path="password" maxlength="20" cssClass="wi80 validate[required,length[1,20]]"/><br/>
