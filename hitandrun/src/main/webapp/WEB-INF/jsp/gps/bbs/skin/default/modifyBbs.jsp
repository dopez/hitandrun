			...
			<td>
				...
				<tr>
					...
					<c:if test="${bbsInfoVO.titleDecoUseAt eq 'Y'}">
						...
						<c:if test="${empty gpsSessionVO || gpsSessionVO.usrId != bbsVO.registerId}">
							<tr>
								<th>비밀번호</th>
								<td>
									<input type="password" id="password" name="password" maxlength="10" class="wi100 validate[required,length[1,10]]"/><br/>
							...
							<tr>
								...
								<td>
									<table class="inside01">
										...
										<tr>
											<td>
												<input name="imgFile" id="imgFile" type="file" onfocus="gfn_focus(this);" onblur="gfn_focusnot(this);" onchange="fn_fileInspct('img',this.id);return false;" title="첨부파일"/>
											</td>
										</tr>
									</table>
								</td>
