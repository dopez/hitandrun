...
author : 통계포털  이진우       
    ...
    date      author             note  
 ----------   -------     ------------------- 
 2011.06.10    이진우                       최초 생성                 
************************************************************************/ 
--%>
function fnAgree(){
	if($('[name=checkField]').is(':checked')){
		<c:set var="userRegistUrl" value="${serverSe == 'naraint'||serverSe == 'naradev'?'/gps/cmm/gpkiInstall.do?se=userRegist':'/gps/user/actionAgreementConfirm.do'}"/>
		JQ_request('userRegisterVO','<c:url value='${userRegistUrl}'/>','userRegisterVO');
	}else{
...
<div id="subpagebody_contents">
	...
	<div class="agreementprocess">
		<div class="agreementflow">
			<ul>
				<li><img src="/images/gps/contents/member/member_im_01_on.gif" alt="약관동의" title="약관동의"></li>
		...
		<div class="agreencommit">
			<ul>
				<li>나라통계의 회원으로 가입하시면 회원 약관에 동의 하신 후 가입절차에 따라 가입하시면 됩니다.</li>
			</ul>
		</div>
	</div>
	<form:form method="post" commandName="userRegisterVO">
	...
	<div class="agreement">
		...
		<div class="useStplatCn">
			<ul>
				<li>
					<textarea id="useStplatCn" cols="113" rows="15" title="나라통계포털 인터넷서비스 이용약관">
나라통계포털 인터넷서비스 이용약관
제1조(목적)
본 약관은 나라통계 포털사이트(이하 "당 사이트")가 제공하는 모든 서비스(이하 "서비스")의 이용조건 및 절차, 이용자와 당 사이트의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.

제 2 조 (약관의 효력과 변경)
① 당 사이트는 귀하가 본 약관 내용에 동의하는 것을 조건으로 귀하에게 서비스를 제공할 것이며, 귀하가 본 약관의 내용에 동의하는 경우, 당 사이트의 서비스 제공 행위 및 귀하의 서비스 사용 행위에는 본 약관ㆍ우선적으로 적용될 것입니다.
② 당 사이트는 본 약관을 사전 고지 없이 변경할 수 있으며, 변경된 약관은 당 사이트 사이트 내에 공지함으로써 이용자가 직접 확인하도록 할 것입니다. 이용자가 변경된 약관에 동의하지 아니하는 경우, 이용자는 본인의 회원등록을 취소(회원탈퇴)할  수 있으며, 계속 사용의 경우는 약관 변경에 대한 동의로 간주됩니다. 변경된 약관은 공지와 동시에 그 효력이 발생됩니다.
...
③ 회 원 : 당 사이트에 개인 정보를 제공하여 회원 등록을 한 자로서, 당 사이트의 정보를 제공받으며, 당 사이트가 제공하는 서비스를 이용할 수 있는 자
...
① 회원의 개인정보는 공공기관의 개인정보보호에 관한 법률에 의해 보호되며 당 사이트의 개인정보보호정책이 적용됩니다.(2011.08.27)
...
3. 개인정보의 관리 : 귀하는 개인정보의 보호 및 관리를 위하여 서비스의 개인정보관리에서 수시로 귀하의 개인정보를 수정/삭제할 수 있습니다. 수신되는 정보 중 불필요하다고 생각되는 부분도 변경/조정할 수 있습니다. 개인정보의 이용기간은 귀하가 가입을 완료하고 개인정보관리에서 회원가입을 탈퇴하는 시점이며 보호기간도 동일합니다.(2011.08.27)
...
제 7 조 (이용자의 정보 보안)
① 가입 신청자가 당 사이트 서비스 가입 절차를 완료하는 순간부터 귀하는 입력한 정보의 비밀을 유지할 책임이 있으며, 회원의 ID와 비밀번호를 사용하여 발생하는 모든 결과에 대한 책임은 회원 본인에게 있습니다.
...
① 귀하가 제공하는 정보의 내용이 허위인 것으로 판명되거나, 그러하다고 의심할 만한 합리적인 사유가 발생할 경우 당 사이트는 
귀하의 본 서비스 사용을 일부 또는 전부 중지할 수 있으며, 이로 인해 발생하는 불이익에 대해 책임을 부담하지 아니합니다.
...
제 15 조 (회원의 의무)
① 회원 가입시에 요구되는 정보는 정확하게 기입하여야 합니다. 또한 이미 제공된 귀하에 대한 정보가 정확한 정보가 되도록 유지, 갱신하여야 하며, 회원은 자신의 ID 및 비밀번호를 제3자에게 이용하게 해서는 안 됩니다.
...
② 귀하는 당 사이트가 명시적으로 승인한 경우를 제외하고는 전항의 소정의 각 재산에 대한 전부 또는 일부의 수정, 대여, 대출, 판매, 배포, 제작, 양도, 재라이센스, 
...
(시행일) 본 약관은 2007년 3월 5일부터 시행됩니다.
(시행일) 본 약관은 2011년 8월 27일부터 시행됩니다.
					</textarea>
				</li>
			</ul>
		</div>
	</div>
	<div class="confirm_chk">
		<ul>
			<li><input type="checkbox" id="checkField" name="checkField" title="약관내용" alt="약관내용" checked="checked"/></li>
			<li><label for="checkField">약관내용에 동의합니다.</label></li>
		</ul>
	</div>
	<div class="confirm_btn">
		<a href="#LINK" onclick="fnAgree(); return false;"><img src="/images/gps/contents/member/bt_consent_on.gif" alt="동의" title="동의"></a>
		<a href="#LINK" onclick="fnDisAgree(); return false;"><img src="/images/gps/contents/member/bt_no-consent_off.gif" alt="동의안함" title="동의안함"></a>
	</div>
	</form:form>
</div>
