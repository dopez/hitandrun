...
function fn_regist(){
	if(confirm("<spring:message code='common.save.msg' />")){
		JQ_request("codeManageVO", "<c:url value='/gps/adm/code/insertCode.do'/>");
	}
}
		...
		<td class="pl5 cb vt">
			...
			<tr>
				<td>
					...
					<tr>
						<td><a onclick="javasciprt:fn_regist();" style="cursor:pointer;"><img src="/images/button/0210.png" alt="<spring:message code="button.create" />" title="<spring:message code="button.create" />" ></a></td>
						<td class="end"><a onclick="history.back(-1);" style="cursor:pointer;"><img src="/images/button/0203.png" alt="<spring:message code="button.reset" />" title="<spring:message code="button.list" />"></a></td>
					</tr>
					</table>
				</td>
			</tr>
