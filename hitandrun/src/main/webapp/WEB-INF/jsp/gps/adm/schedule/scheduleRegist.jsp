...
function fn_regist(){
	...
	if(confirm("<spring:message code='common.save.msg' />")){
		JQ_request("scheduleManageVO", "<c:url value='/gps/adm/schedule/insertSchedule.do'/>");
	}
...
<div class="contents_area">
	<form:form commandName="scheduleManageVO" name="scheduleManageVO" method="post">
							...
							<td>
								...
								<tr>
									...
									<td>
										<table class="inner01">
										<tr>
											<td class="input_bottom_noline"><form:input id="startDe" path="startDe" cssClass="validate[required,funcCall[chkCal]] text-input wi100" /></td>
