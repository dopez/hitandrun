...
/************************************************************************ 
함수명 : fn_list                                   
설   명 : "목록"버튼을 클릭했을때 약관 리스트로 돌아가는 화면       
인   자 : 없음        
사용법 : fn_list()
작성일 : 2011-06-20   
작성자 : 범정부통계포털 이관형           
...
function fn_update(){
	if(confirm("<spring:message code='common.save.msg' />")){
		JQ_request("stplatManageVO", "<c:url value='/gps/adm/stplat/updateStplat.do'/>");
	}
}
...
function fn_delete(){
	if(confirm("<spring:message code='common.delete.msg' />")){
		JQ_request("stplatManageVO", "<c:url value='/gps/adm/stplat/deleteStplat.do'/>");
	}
}
</script>
<!-- page contents start -->
<div class="contents_area">
	...
	<form:hidden path="sysIdSearch" id="sysIdSearch"/>
				...
				<td class="pl5 cb vt">
					...
					<tr>
						<td>
							...
							<tr>
								...
								<td class="input"><form:textarea path="stplatCn" cssClass="wi500 ht500 validate[required,length[1,4000]]"/></td>
							</tr>
							<tr>
					...
					<tr>
						<td>
							...
							<tr>
								<td><a onclick="fn_update();"><img src="/images/button/0210.png" alt="<spring:message code="button.save" />" title="<spring:message code="button.save" />"></a></td>
								<td><a onclick="fn_delete();"><img src="/images/button/0204.png" alt="<spring:message code="button.delete" />" title="<spring:message code="button.delete" />"></a></td>
