...
function fn_regist(){
	if(confirm("<spring:message code='common.save.msg' />")){
		...
		JQ_request("programManageVO", "<c:url value='/gps/adm/program/insertProgram.do'/>");
	}
}
</script>
			...
			<td class="pl5 cb vt">
				...
				<tr>
					<td>
						<table class="title">
						<tr>
							<td class="icon"><img src="/images/gps/adm/icon/026.gif" alt="프로그램 등록" title="프로그램 등록"/></td>
							<td class="title">프로그램 등록</td>
						</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td>
						...
						<tr>
							<th class="reqsubject">프로그램 파일명</th>
						...
						<tr>
							<th class="reqsubject">프로그램 저장경로</th>
						...
						<tr>
							<th class="reqsubject">프로그램 한글명</th>
						...
						<tr>
							<th class="reqsubject">프로그램 유형</th>
							<td class="input">
								<table class="inside02">
								<tr>
									<td class="input"><input type="checkbox" class="noline validate[minCheckbox[1]] checkbox" name="programTy" id="programTyReadChk" /></td>
									<td>읽기</td>
									<td class="input"><input type="checkbox" class="noline validate[minCheckbox[1]] checkbox" name="programTy" id="programTyCreateChk" /></td>
									<td>등록</td>
									<td class="input"><input type="checkbox" class="noline validate[minCheckbox[1]] checkbox" name="programTy" id="programTyUpdateChk" /></td>
									<td>수정</td>
									<td class="input"><input type="checkbox" class="noline validate[minCheckbox[1]] checkbox" name="programTy" id="programTyDeleteChk" /></td>
									<td>삭제</td>
								</tr>
								</table>
							</td>
						...
						<tr>
							...
							<td class="input"><form:input path="programDc" size="60" cssClass="wi500 validate[optional,length[6,300]] text-input" maxlength="60" /></td>
						</tr>
						<tr>
							<th class="reqsubject">URL</th>
