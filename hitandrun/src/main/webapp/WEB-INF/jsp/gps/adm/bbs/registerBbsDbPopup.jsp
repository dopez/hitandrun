...
/** 
 * outline   : 게시판DB정보등록화면
 * filename : registerBbsDBPopup.jsp
 * @author 통계포탈 황기연 
 * @since 2011.06.28
 * @version 1.0 
 * @see 
...
function fncPageOnload(){
	...
	opener.location.href="<c:url value='/gps/adm/bbs/selectBbsDbList.do'></c:url>";
	window.close();
	</c:if>
...
function fn_insert(){
	JQ_setProcessMsg();
	JQ_request("bbsDbVO", "<c:url value='/gps/adm/bbs/insertBbsDb.do'/>");
}
					...
					<tr>
						<td>
							...
							<tr>
								...
								<td class="input">
									<form:password path="dbMngrPassword" cssClass="validate[required,length[1,50]]"/>
								</td>
							</tr>
							<tr>
