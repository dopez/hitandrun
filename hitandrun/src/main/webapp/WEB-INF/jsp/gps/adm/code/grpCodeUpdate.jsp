...
function fncPageOnload()
{
	<c:if test="${!empty message}">
		...
		parent.codeFrame.location.href = "/gps/adm/code/selectGrpCodeList.do?upperCodeId=" + document.updateForm.upperCodeId.value;
		parent.subCodeFrame.location.href = "/gps/adm/code/selectCodeList.do?upperCodeId=" + document.updateForm.codeId.value;
	</c:if>
 ...
 ************************************************************************/
 ...
 function fn_delete(){
 	if(confirm("<spring:message code='common.perfectdelete.msg' />")){		
 		JQ_request("codeManageVO", "<c:url value='/gps/adm/code/deleteGrpCode.do'/>");
 	}
 }
...
function fn_modify(){
	...
	if(confirm("<spring:message code='common.update.msg' />")){
		// parent.frames.codeFrame.location.reload(true);
		JQ_request("codeManageVO", "<c:url value='/gps/adm/code/updateGrpCode.do'/>");
	}
}
</script>
<%-- javascript end ============================================--%>
				...
				<td>
					...
					<tr>
						...
						<td class="no_padding">
							<table class="inside02">
							<tr>
								<td class="input"><form:input path="validBgnde"  size="10" cssStyle="vertical-align:middle" cssClass="input_t input_nara_date" onfocus="gfn_focus(this);" onblur="gfn_focusnot(this);"/></td>
							</tr>
							</table>
						</td>
					</tr>
					<tr>
						...
						<td class="no_padding">
							<table class="inside02">
							<tr>
								<td class="input"><form:input path="validEndde"  size="10" cssStyle="vertical-align:middle" cssClass="input_t input_nara_date" onfocus="gfn_focus(this);" onblur="gfn_focusnot(this);"/></td>
							</tr>
							</table>
						</td>
					</tr>
