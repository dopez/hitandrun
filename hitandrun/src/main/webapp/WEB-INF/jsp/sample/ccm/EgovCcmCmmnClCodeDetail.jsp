...
<link rel="stylesheet" href="/css/sample/ccm/com.css" type="text/css">
<link rel="stylesheet" href="/css/sample/ccm/button.css" type="text/css">
...
function fnModify(){
	...
	varForm.action           = "<c:url value='/sample/ccm/ccc/EgovCcmCmmnClCodeModify.do'/>";
...
function fnDelete(){
	if (confirm("<spring:message code="common.delete.msg" />")) {
		var varForm				 = document.all["Form"];
		varForm.action           = "<c:url value='/sample/ccm/ccc/EgovCcmCmmnClCodeRemove.do'/>";
		varForm.clCode.value     = "${result.clCode}";
		varForm.submit();
	}
}
...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left"><h1 class="title_left">
   <img src="/images/sample/ccm/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목">&nbsp;공통분류코드 상세조회</h1></td>
 </tr>
</table>
...
<CAPTION style="display: none;">공통분류코드 상세조회</CAPTION>
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row" nowrap >분류코드<img src="/images/sample/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>
    <td>${result.clCode}</td>
  </tr>
  <tr>
  ...
  <tr> 
    <th height="23" class="required_text" scope="row" >분류코드설명<img src="/images/sample/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>
...
<tr> 
  <td><img src="/images/sample/ccm/btn/bu2_left.gif" alt="수정" width="8" height="20"></td>
  <td style="background-image:URL(<c:url value='/images/sample/ccm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fnModify(); return false;">수정</a></td>
  <td><img src="/images/sample/ccm/btn/bu2_right.gif" alt="수정" width="8" height="20"></td>
  <td width="10"></td>
  
  <c:if test="${result.useAt == 'Y'}">
  <td><img src="/images/sample/ccm/btn/bu2_left.gif" width="8" height="20"></td>  
  <td style="background-image:URL(<c:url value='/images/sample/ccm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fnDelete(); return false;">삭제</a></td>  
  <td><img src="/images/sample/ccm/btn/bu2_right.gif" alt="삭제" width="8" height="20"></td>
  <td width="10"></td>
  </c:if>
