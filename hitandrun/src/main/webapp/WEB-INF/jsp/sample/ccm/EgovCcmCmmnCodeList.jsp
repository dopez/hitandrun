...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/sample/ccm/cca/EgovCcmCmmnCodeList.do'/>";
 ...
 ******************************************************** */
function fnRegist(){
	location.href = "/sample/ccm/cca/EgovCcmCmmnCodeRegist.do";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
...
function fnDetail(codeId){
	...
	varForm.action           = "<c:url value='/sample/ccm/cca/EgovCcmCmmnCodeDetail.do'/>";
...
<form name="listForm" action="<c:url value='/sample/ccm/cca/EgovCcmCmmnCodeList.do'/>" method="post">
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left"><h1 class="title_left">
   <img src="/images/sample/ccm/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목">&nbsp;공통코드 목록</h1></td>
  <th>
  </th>
  <td width="10%">
