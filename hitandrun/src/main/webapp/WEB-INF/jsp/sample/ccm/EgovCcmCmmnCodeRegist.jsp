...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left"><h1 class="title_left">
   <img src="/images/sample/ccm/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목">&nbsp;공통코드 등록</h1></td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<CAPTION style="display: none;">공통코드 등록</CAPTION>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap ><label for="clCode">분류코드</label><img src="/images/sample/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>          
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap ><label for="codeId">코드ID</label><img src="/images/sample/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap colspan="3">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap ><label for="codeIdNm">코드ID명</label><img src="/images/sample/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap>
...
<tr> 
  ...
  <td style="background-image:URL(<c:url value='/images/egovframework/cop/bbs/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fn_egov_list_CmmnCode(); return false;">목록</a></td>
