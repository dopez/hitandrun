 ...
 * 	 2011.08.31	   황기연			  listPaging 메소드 추가
 * @author 실행환경 개발팀 우병훈
 * @since 2009. 02. 25
 * @version 1.0 
 * 
...
public class GpsAbstractDAO extends SqlMapClientDaoSupport {
     ...
     */
    @SuppressWarnings("unchecked")
    public List listPaging(String queryId, Object parameterObject,int firstIndex, int recordCountPerPage) {
