...
import com.bbm.sample.dcm.service.ExmnrexaminationListShService;
...
@Service("ExmnrexaminationListShService")
public class ExmnrexaminationListShServiceImpl extends AbstractServiceImpl implements ExmnrexaminationListShService { 

    
    /** CommonGridDAO 서비스 호출 */ 
	@Resource(name="ExmnrexaminationListShDAO")
    private ExmnrexaminationListShDAO exmnrexaminationListShDAO;

	/**
	 * 조사원 조사입력 (사회) Grid Setting
    ...
    public List SelectGridList(String sql_id, Map map) {
    	...
    	return exmnrexaminationListShDAO.SelectGridList(sql_id, map);
    }
	/**
	 * 조사원 조사입력 (사회) Grid Setting
	 * @param sql_id,map - 검색할 SQL ID 와 검색조건 의 값 
    ...
    public List SelectSerchList(String sql_id, Map map) {
    	...
    	return exmnrexaminationListShDAO.SelectSerchList(sql_id, map);
    }
	/**
	 * 조사원 조사입력(사회) Grid 로드
	 * @param sql_id,map - 검색할 SQL ID 와 검색조건 의 값 
    ...
    public List SelectTable(String sql_id, Map map) {
    	...
    	return exmnrexaminationListShDAO.SelectTable(sql_id, map);
    }
	/**
    ...
    public List SelectTablecnt(String sql_id, Map map) {
    	...
    	return exmnrexaminationListShDAO.SelectTablecnt(sql_id, map);
    }
	/**
	 * 검색조건에 입력된 값의 검색정보
	...
	public Map selectCmmCodeMap(ExmnrexaminationListShVO vo) throws Exception {
    	return exmnrexaminationListShDAO.selectCmmCodeMap(vo);
    }
     ...
     */
	 public List<ExmnrexaminationListShVO> selectCmmCodeDetail1(ExmnrexaminationListShVO vo) throws Exception {
		return exmnrexaminationListShDAO.selectCmmCodeDetail1(vo);
	 }
