...
public class FileManageDAO extends EgovAbstractDAO {
    ...
    public void deleteFileInfs(List fileList) throws Exception {
		...
		while (iter.hasNext()) {
		    ...
		    try {
		    	FileVO f_vo = (FileVO)selectByPk("FileManageDAO.selectFileInf", vo);
		    	
			    String s = f_vo.getFileStreCours() + File.separator + f_vo.getStreFileNm();
    ...
    public void deleteFileInf(FileVO fvo) throws Exception {
        ...
        boolean bdelete = true; 
	    try {
	    	FileVO f_vo = (FileVO)selectByPk("FileManageDAO.selectFileInf", fvo);
		    String s = f_vo.getFileStreCours() + File.separator + f_vo.getStreFileNm();
		    File f = new File(s);
		    f.delete();
		    bdelete = true;
	...
	return (FileVO)selectByPk("FileManageDAO.selectFileTableInf", fvo);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public List<FileVO> selectFileTableInfs(FileVO vo) throws Exception {
    	return list("FileManageDAO.selectFileTableList", vo);
    }
